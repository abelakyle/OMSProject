...
public abstract class DB {
    protected String URL = "jdbc:derby://localhost:1527/OMS_DB";//replace empty-string with jdbc:derby local host url
    protected String db = "OMS_DB";//name of the database
